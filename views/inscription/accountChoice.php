...
<div class="back">
    <div class="container">
        <h1> Inscription </h1>
        <form formclass="col-lg-6" method="post" action="<?=$websiteRoot?>/inscription/updateAccount">
            <div class="card-deck" style="margin-bottom:10px">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button class="btn" onclick="changeOption('company')"><?php echo _("Choose this option"); ?></button>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button class="btn" onclick="changeOption('subscriber')"><?php echo _("Choose this option"); ?></button>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button class="btn" onclick="changeOption('volunteer')"><?php echo _("Choisir cette option"); ?></button>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button class="btn" onclick="changeOption('none')"><?php echo _("Choisir mon option plus tard") ?> </button>
                    </div>
                </div>  
            </div>
        </form>
