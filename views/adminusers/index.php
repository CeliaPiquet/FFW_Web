...
<div class="container-fluid">
    ...
    <table class="table table-striped table-hover " id="usersTable">
        ...
        <tr >
            <td>
                <input type="text" class="form-control" onkeyup="findLocalsByFilter()" id="mailInput" placeholder="<?php echo _("Mail");?>">
            </td>
            <td>
                <input type="text" class="form-control" onkeyup="findLocalsByFilter()" id="lastnameInput" placeholder="<?php echo _("Last name"); ?>">
            </td>
            <td>
                <input type="text" class="form-control" onkeyup="findLocalsByFilter()" id="firstnameInput" placeholder="<?php echo _("First name"); ?>">
            </td>
            <td>
                <input type="text" class="form-control" onkeyup="findLocalsByFilter()" id="cityInput" placeholder="<?php echo _("City"); ?>">
            </td>

            <td>
                <select type="text" class="form-control" onchange="findLocalsByFilter()" id="skillsSelect">
            ...
            <td>
                <select type="text" class="form-control" onchange="findLocalsByFilter()" id="skillsStatusSelect">
                    <option selected></option>
                    <?php
            ...
            <td>
                <select type="text" class="form-control" onchange="findLocalsByFilter()" id="rightsSelect">
                    <option selected></option>
                    <?php
...
<div class="modal fade" id="skillsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="false">
