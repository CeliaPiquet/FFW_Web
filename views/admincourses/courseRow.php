...
<td>
    ...
    <input type="time" name="courseInput"  class="form-control" id="serviceStartTime" onchange="changeServiceTime(this);"  object="service" disabled>
</td>
<td>
...
<td>
    ...
    <input type="time" name="courseInput"  class="form-control" id="serviceEndTime" onchange="changeServiceTime(this);" object="service" disabled>
</td>
<td>
    <button class="btn  mx-auto"   name="courseInput" id="description" object="vehicle" onclick="openVehiclesModal(this);" type="button" ><?php echo _("Select vehicle");?></button>
</td>
<td>
...
<td>
    <button class="btn  mx-auto" name="courseInput"  id="lastname" object="user" type="button" onclick="openDriversModal(this);" disabled ><?php echo _("Select driver");?></button>
</td>
